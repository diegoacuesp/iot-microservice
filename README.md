## iot-microservice
Este repoitorio es la primera versión del desarrollo realizado para un cliente el cual desplego un sistema IOT y necesitaba el desarrollo backend IOT para su sistema.
